...
define('PLUGIN_BULKRESOLVE_VERSION', '0.1.1');
...
function plugin_version_bulkresolve() {
   return ['name'=>'Bulk Resolve Tickets','version'=>PLUGIN_BULKRESOLVE_VERSION,'author'=>'Nicolabs91','license'=>'GPLv3+','homepage'=>'https://github.com/nicolabs91/bulkresolve','requirements'=>['glpi'=>['min'=>'11.0.0','max'=>'11.99.99']]];
}
